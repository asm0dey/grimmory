...
public class LibraryRescanHelper {
    ...
    private final ObjectProvider<BookMetadataUpdater> bookMetadataUpdater;
    private final NotificationService notificationService;
    private final TaskCancellationManager cancellationManager;
    private final BookRepository bookRepository;
    private final AudiobookProcessor audiobookProcessor;

    public LibraryRescanHelper(LibraryRepository libraryRepository, MetadataExtractorFactory metadataExtractorFactory, ObjectProvider<BookMetadataUpdater> bookMetadataUpdater, NotificationService notificationService, TaskCancellationManager cancellationManager, BookRepository bookRepository, AudiobookProcessor audiobookProcessor) {
        ...
        for (BookEntity bookEntity : bookEntities) {
            ...
            try {
                ...
                MetadataUpdateContext metadataUpdateContext = MetadataUpdateContext.builder()
                        ...
                        .mergeTags(true)
                        .build();
                bookMetadataUpdater.getObject().setBookMetadata(metadataUpdateContext);
